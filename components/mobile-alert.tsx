...
const MobileAlert = () => {
    return (
        <main className="bg-black text-white relative inset-0 bg-[url(../public/grid.svg)] bg-center [mask-image:linear-gradient(180deg,rgba(255,255,255,0))] h-[100vh] w-screen" >
